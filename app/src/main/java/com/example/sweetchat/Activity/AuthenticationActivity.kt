package com.example.sweetchat.Activity
...
import com.example.sweetchat.Login
import com.example.sweetchat.R
import com.example.sweetchat.SignUp
...
class AuthenticationActivity : AppCompatActivity(),FirebaseAuth.AuthStateListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewPager = findViewById(R.id.viewPaperAuthentication)
